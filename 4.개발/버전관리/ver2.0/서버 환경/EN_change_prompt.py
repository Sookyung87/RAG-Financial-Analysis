...
def get_rag_answer(query, model_name="text-embedding-3-small"):
    ...
    prompt = PromptTemplate(
        ...
        template="You are a stock advisory system. When you provide answers about the stock market, you prioritize the most recent data and provide answers based on the data closest to the current date. "
                 "You need to reflect the latest trends, news, reports, and market data to provide your customers with the most reliable information. The current date is {date}, and the following documents are for your reference:\n\n{context}\n\nQuestion: {question}\n\n"
